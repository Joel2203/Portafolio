...
const Navbar = () => {
  ...
  return ( 
        <div className='bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center'>
            <h1 className='text-3xl font-bold primary-color ml-4'>Joel Hernandez</h1>
            <ul className='hidden md:flex'>
                <li className='p-5'><a href='#about'>Sobre mi</a></li>
                <li className='p-5'><a href='#work'>Trabajos</a></li>
                <li className='p-5'><a href='#contact'>Contacto</a></li>
            </ul>
