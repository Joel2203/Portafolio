...
const Work = () => {
  return (
    <div className='max-w-[1200px] mx-auto p-5' id='work'>
      <div className='pb-8'>
        <p className='text-4xl mb-3 font-bold primary-color'>Trabajos</p>
        <p className='text-gray-400'>Trabajaos realizados</p>
      </div>
      ...
      <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
        ...
        <div className='transform transition-transform duration-300 hover:scale-105 overflow-hidden
          ...
          <div className='opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col 
            ...
            <span className='text-2xl font-bold text-white tracking-wider'>Trabajos</span>
